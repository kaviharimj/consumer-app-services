                                ...
                                if(rows_VD.length > 0) {
									...
									con.query(queryString_VC,function(err_VC,rows_VC) {
										if(rows_VC.length > 0) {
                                            ...
                                            if(rows_VD[0].upload_auto_insurance!=''){
                                                rows_VD['0']['upload_auto_insurance'] = 'http://iot.boommotors.com/evehicle_secure/other_uploads/customer_proofs/'+rows_VD[0].upload_auto_insurance; 
                                            }else{
                                                rows_VD['0']['upload_auto_insurance'] ='' ;
                                            }
                                            if(rows_VD[0].upload_driving_license!=''){
                                                rows_VD['0']['upload_driving_license'] = 'http://iot.boommotors.com/evehicle_secure/other_uploads/customer_proofs/'+rows_VD[0].upload_driving_license; 
                                            }else{
                                                rows_VD['0']['upload_driving_license'] ='';
                                            }
                                            if(rows_VD[0].upload_rc_book!=''){
                                                rows_VD['0']['upload_rc_book'] = 'http://iot.boommotors.com/evehicle_secure/other_uploads/customer_proofs/'+rows_VD[0].upload_rc_book; 
                                            }else{
                                                rows_VD['0']['upload_rc_book'] ='';
                                            }
