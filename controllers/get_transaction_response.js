...
module.exports.get_transaction_response =
 function (req, res) {
    var res_arr,re_arr;
                ...
                con.query(queryString_U, function (err_U, rows_U) { 
                    if (rows_U.length > 0) {
                        if(rows_U[0].status == 1){
                            ...
                            //////=========================== MAIN =================================================/////// 
                         var queryString_RES ="SELECT imei,battery_mode,battery_soc FROM ss_battery_history_event  WHERE imei = '"+imei+"'  ORDER BY gps_datetime desc limit 0,1";
